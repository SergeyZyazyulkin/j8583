...
public class IsoMessage {
    ...
    public IsoMessage setField(int index, IsoValue<?> field) {
    	...
    	if (field != null) {
            ...
            if (fields[index] != null) {
                field.setBinaryLengthIfNotSet(fields[index].getBinaryLength());
                field.setBinaryValueIfNotSet(fields[index].getBinaryValue());
            }
    	}
    	fields[index] = field;
    	return this;
    ...
    public <T> IsoMessage setValue(int index, T value, CustomField<T> encoder, IsoType t, int length) {
    	...
    	if (value == null) {
    		...
    		if (fields[index] != null) {
    		    v.setBinaryLength(fields[index].getBinaryLength());
                v.setBinaryValue(fields[index].getBinaryValue());
            }
    		fields[index] = v;
    	}
    	return this;
    ...
    public <T> IsoMessage updateValue(int index, T value) {
        ...
        if (current == null) {
            ...
            getField(index).setBinaryLength(current.getBinaryLength());
            getField(index).setBinaryValue(current.getBinaryValue());
        }
        return this;
    }
