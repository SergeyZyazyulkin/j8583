...
public abstract class FieldParseInfo {
	...
	public boolean isBinaryLength(boolean defaultValue) {
		return binaryLength != null ? binaryLength : defaultValue;
	}
	...
	public boolean isBinaryValue(boolean defaultValue) {
		return binaryValue != null ? binaryValue : defaultValue;
	}
	...
	public <T> IsoValue<?> parse(
			final int field, byte[] buf, int pos, CustomField<T> custom, final boolean binaryLength)
			throws ParseException, UnsupportedEncodingException {
